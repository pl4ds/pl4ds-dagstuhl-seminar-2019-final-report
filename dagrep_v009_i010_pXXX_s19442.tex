...
\keywords{Programming Languages, Distributed Systems, Data Management}%mandatory
...
%%%%%%%%%%%%%%%%
\abstracttitle{Scaling distributed systems reliably}
...
%%%%%%%%%%%%%%%%
\abstracttitle{Data programming for ML and Data Science -- Challenges for data management, compilers, and distributed systems}
\abstractauthor[Volker Markl]{Volker Markl (TU Berlin, Germany). Abstract contributed to the report.}
